...
export const getRoleInfo = (id: number): Promise<ISysHttpResponse> => {
  return http({
...
export const deleteRoleData = (ids: string[]): Promise<ISysHttpResponse> => {
  return http({
    url: "/sys/role/delete",
    method: "post",
    data: ids
...
export const roleDataSave = (data: RoleInfoParams): Promise<ISysHttpResponse> => {
  return http({
    url: "/sys/role/save",
    method: "post",
    data
...
export const roleDataUpdate = (data: RoleInfoParams): Promise<ISysHttpResponse> => {
  return http({
    url: "/sys/role/update",
    method: "post",
    data
